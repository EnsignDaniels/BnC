...
from GDDL_cb import generateGDDL_cuts
from simplecut_cb import generateSimple_cuts
from Twopath_cb import generate_2path_cuts
from ThreevGDDL_cb import generate_3vGDDL_cuts
from FourvGDDL_cb import generate_4vGDDL_cuts
        ...
        if status == GRB.OPTIMAL:
        	...
        	if model._GAP > CUT_OFF_GAP:
        		if ENABLE_BALAS_CUTS:
        			...
        			print(f'Node {nodecnt}, Pi {number_of_BalasPi_cuts}, Sigma {number_of_BalasSigma_cuts}, Pi+Sigma {number_of_BalasPS_cuts}')
        		#if nodecnt % 100 == 0:
        		...
        		if ENABLE_GDDL_CUTS and (not ENABLE_BALAS_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE):
        			...
        			print(f'Node {nodecnt}, GDDL {number_of_GDDL_cuts}')
        		if ENABLE_SIMPLE_CUTS and (not ENABLE_BALAS_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE):
        			...
        			print(f'Node {nodecnt}, Simple cuts {number_of_Simple_cuts}')
        		...
        		if ENABLE_2PATH_CUTS and (ENABLE_3vGDDL_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE):  
        			...
        			print(f'Node {nodecnt}, 2-path cuts {number_of_2path_cuts}')
        		...
        		if ENABLE_3vGDDL_CUTS and (ENABLE_4vGDDL_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE): 
        			...
        			print(f'Node {nodecnt}, 3vGDDL cuts {number_of_3vGDDL_cuts}')
        		...
        		if ENABLE_4vGDDL_CUTS and LB < model._prevBestLB * BEST_BOUND_RATE:  
        			...
        			print(f'Node {nodecnt}, 4vGDDL cuts {number_of_4vGDDL_cuts}')
