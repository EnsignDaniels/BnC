        ...
        if status == GRB.OPTIMAL:
        	...
        	if model._GAP > CUT_OFF_GAP:
        		...
        		if ENABLE_GDDL_CUTS: #and (not ENABLE_BALAS_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE):
        			...
        			size_of_ratings = sys.getsizeof(model._GDDL_rates) / 10**9
        			print(f'Cb   {nodecnt}, Strengthened GDDL   cuts: {number_of_GDDL_cuts:4} out of {out_of:8} | size {size_of_ratings:.2f} GB')
        		...
        		if ENABLE_SIMPLE_CUTS:# and (not ENABLE_BALAS_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE):
        			...
        			zise_of_ratings = sys.getsizeof(model._Simple_rates) / 10**9
        			print(f'Cb   {nodecnt}, Strengthened Simple cuts: {number_of_Simple_cuts:4} out 0f {out_of:8} | size {size_of_ratings:.2f} GB')
        		...
        		if ENABLE_2PATH_CUTS: #and (ENABLE_3vGDDL_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE):  
        			...
        			size_of_ratings = sys.getsizeof(model._2path_rates) / 10**9
        			print(f'Cb   {nodecnt}, Strengthened 2-path cuts: {number_of_2path_cuts:4} out 0f {out_of:8} | size {size_of_ratings:.2f} GB')
        		...
        		if ENABLE_3vGDDL_CUTS: #and (ENABLE_4vGDDL_CUTS or LB < model._prevBestLB * BEST_BOUND_RATE): 
        			...
        			print(f'Cb   {nodecnt}, Strengthened 3vGDDL cuts: {number_of_3vGDDL_cuts:4} out 0f {out_of:8} | size {size_of_ratings:.2f} GB')
        		...
        		if ENABLE_4vGDDL_CUTS: #and LB < model._prevBestLB * BEST_BOUND_RATE:  
        			...
        			print(f'Cb   {nodecnt}, Strengthened 4vGDDL cuts: {number_of_4vGDDL_cuts:4} out 0f {out_of:8} | size {size_of_ratings:.2f} GB')
